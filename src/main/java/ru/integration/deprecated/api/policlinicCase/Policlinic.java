package ru.integration.deprecated.api.policlinicCase;
...
import ru.integration.deprecated.entities.EvnPLBaseEntity;
import ru.integration.deprecated.entities.EvnVizitPLEntity;
import ru.integration.deprecated.entities.medosEntities.MedosDiagnosisEntity;
import ru.integration.deprecated.entities.medosEntities.MedosMedcaseEntity;
import ru.integration.deprecated.entities.medosEntities.MedosPatientEntity;
import ru.integration.deprecated.entities.medosEntities.MedosVochospitalizationEntity;
import ru.integration.deprecated.entities.medosEntities.MedosVocidc10Entity;
import ru.integration.deprecated.entities.medosEntities.MedosVocreasonEntity;
import ru.integration.deprecated.entities.medosEntities.MedosVocservicestreamEntity;
import ru.integration.deprecated.entities.medosEntities.MedosVocvisitresultEntity;
import ru.integration.deprecated.entities.medosEntities.MedosVocworkplacetypeEntity;
import ru.integration.deprecated.entities.medosEntities.MedosWorkfunctionEntity;
      ...
      /*  List<MedosMedcaseEntity> policlinicCases = new DaoImpl().getMedosEntityList("MedosMedcaseEntity m",
       ...
       /* List<MedosMedcaseEntity> policlinicCases = new DaoImpl().getMedosEntityList("MedosMedcaseEntity m",
        ...
        for (MedosMedcaseEntity policlinicCase : policlinicCases) {
            ...
            if (policlinicCase.getUpload() != null && policlinicCase.getUpload()) {
                continue;
            }
