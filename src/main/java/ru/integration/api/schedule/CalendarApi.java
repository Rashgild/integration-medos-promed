package ru.integration.api.schedule;
...
import ru.integration.entities.schedule.BusyDateEntity;
import ru.integration.entities.schedule.BusyTimeEntity;
...
public class CalendarApi {
    ...
    public static String getBusyDateTimes() {
        ...
        for (ListBusyDateTimeEntity v : listBusyDateTimeEntity) {

            HashMap<String, String> params = new HashMap<>();
            params.put("TimeTableGraf_id", String.valueOf(v.getTimeTableGraf_id()));
            String json = creteGetRequest("api/TimeTableGraf/TimeTableGrafById", params);

            new PersonEntity().saveJson(getPersonById(String.valueOf(v.getPerson_id())));
            ...
            if (checkCode(jparse)) {
                ...
                for (JsonElement medspecs : data) {
                    try {
                        ...
                        busyTimeEntity.setPatient_id(v.getPerson_id());
                        ...
                        new DaoImpl().updateRecord("ListBusyDateTimeEntity", params, "where timetablegraf_id = " + v.getTimeTableGraf_id());
                    } catch (Exception e) {
                        e.printStackTrace();
                    }
                }
    ...
    public static String syncWithMedos(@QueryParam("dateBeg") String dateBeg, @QueryParam("doc") String doc) {
        ...
        try {
            ...
            for (VocMedStaffFactMO v : vocMedStaffFactMOS) {
                ...
                System.out.println(dateBeg + "|" + v.getMedosWorkCalendar_id());
                MedosWorkcalendardayEntity wcday = (MedosWorkcalendardayEntity)
                        new DaoImpl().getEntityM("MedosWorkcalendardayEntity", " calendardate='" + dateBeg + "' and workcalendar_id=" + v.getMedosWorkCalendar_id());
